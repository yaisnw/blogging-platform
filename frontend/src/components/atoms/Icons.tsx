...
export const AlignJustifySVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 512 512" fill="currentColor">
...
export const H1SVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="-5 -7 24 24" fill="currentColor">
...
export const H2SVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="-4.5 -7 24 24" fill="currentColor">
...
export const H3SVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="-4.5 -6.5 24 24" fill="currentColor">
...
export const ParagraphSVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M18 5H8.5C6.567 5 5 6.567 5 8.5C5 10.433 6.567 12 8.5 12H10M11 5V19M15 5V19" />
    </svg>
);

export const QuoteSVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 32 32" fill="currentColor">
