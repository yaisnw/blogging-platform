...
export const BoldSVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6zM6 12h9a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z" fill="currentColor"/></svg>
);

export const ItalicSVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M19 4h-9L7.14 20H16L19 4z" fill="currentColor"/></svg>
);

export const UnderlineSVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M6 3v7a6 6 0 0 0 6 6 6 6 0 0 0 6-6V3M4 21h16"/></svg>
);

export const StrikeSVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M16 4H9a3 3 0 0 0-2.83 4M14 12a4 4 0 0 1 0 8H6M4 12h16"/></svg>
);

export const AlignLeftSVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 21h18v-2H3v2zM3 7V5h18v2H3zm0 7h12v-2H3v2zm0-4h18V8H3v2zm0 9h12v-2H3v2z" fill="currentColor"/></svg>
);

export const AlignCenterSVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 21h18v-2H3v2zm4-14V5h10v2H7zm-4 7h18v-2H3v2zm2-4h14V8H5v2zm2 9h10v-2H7v2z" fill="currentColor"/></svg>
);

export const AlignRightSVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 21h18v-2H3v2zM3 7V5h18v2H3zm9 7h9v-2h-9v2zm-9-4h18V8H3v2zm9 9h9v-2h-9v2z" fill="currentColor"/></svg>
);

export const AlignJustifySVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 21h18v-2H3v2zM3 7V5h18v2H3zm0 7h18v-2H3v2zm0-4h18V8H3v2zm0 9h18v-2H3v2z" fill="currentColor"/></svg>
);

export const H1SVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M4 12h8m-8-6v12m8-12v12m5-12l2-2v14"/></svg>
);

export const H2SVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M4 12h8m-8-6v12m8-12v12m5-4a3 3 0 1 0 6 0c0-3-6-3-6-6a3 3 0 0 1 6 0m-6 10h6"/></svg>
);

export const H3SVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M4 12h8m-8-6v12m8-12v12m5.5 0a3 3 0 0 1 0-6 2.5 2.5 0 0 1 2 1 2.5 2.5 0 0 1 2-1 3 3 0 0 1 0 6"/></svg>
);

export const ParagraphSVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M13 4H9.5a4.5 4.5 0 0 0 0 9H13M13 15V4h4v11M17 4H13"/></svg>
);

export const QuoteSVG: React.FC<IconProps> = (p) => (
    <svg {...p} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M3 21c3 0 7-1 7-8V5H4v8h4c0 2-1 5-5 5h14c3 0 7-1 7-8V5h-6v8h4c0 2-1 5-5 5"/></svg>
);
...
export const SearchSVG: React.FC<IconProps> = (p) => (
    <svg {...p} viewBox="0 0 1920 1920" role="img" aria-hidden="true">
