    ...
    if (isLoading)
        ...
        return (
            <form onSubmit={handleSubmit} {...props}>
                ...
                <AuthField name="username" label="Enter your username:" value={formData.username} onChange={handleChange} />
                {errors.email && <div>{errors.email}</div>}
                <AuthField name="email" label="Enter email:" type="email" value={formData.email} onChange={handleChange} />
                ...
                <AuthField name="confirmPassword" label="Confirm password:" type='password' value={formData.confirmPassword} onChange={handleChange} />
